    ...
    <div className='card-forSale'>
      ...
      <div className='card-forSale__info'>
        ...
        <div className='card-forSale__shipping-info'>
          ...
          <p>
            Your art print will be placed between two stiff pieces of cardboard
            and put inside a poly bag to protect it from the elements. It will
            then be mailed via USPS in a flat mailer. We put a "Do Not Bend"
            sticker on the front and expect mail carriers to respect the
            request.
          </p>
        </div>
